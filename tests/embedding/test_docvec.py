...
class TestDocVec(unittest.TestCase):
    def setUp(self):
        # This test depends on docvec model. Download according to README.md information.
        # Place the model in the below path
        model_path = "model/bnwiki_doc2vec_model/bnwiki_doc2vec.model"
        self.doc2vec = BengaliDoc2vec(model_path)
